...
#define SchM_Enter_Port(ExclusiveArea) SchM_Enter_Port_## ExclusiveArea
#define SchM_Exit_Port(ExclusiveArea) SchM_Exit_Port_## ExclusiveArea

#define SchM_Enter_Port_PORT_SET_PIN_DIR_PROTECTION              __asm("di")
#define SchM_Exit_Port_PORT_SET_PIN_DIR_PROTECTION               __asm("ei")
