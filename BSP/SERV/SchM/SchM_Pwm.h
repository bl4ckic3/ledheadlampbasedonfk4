...
#define SchM_Enter_Pwm(ExclusiveArea) SchM_Enter_Pwm_## ExclusiveArea 
#define SchM_Exit_Pwm(ExclusiveArea) SchM_Exit_Pwm_## ExclusiveArea

#define SchM_Enter_Pwm_PWM_REGISTERS_PROTECTION           __asm("di")
#define SchM_Exit_Pwm_PWM_REGISTERS_PROTECTION            __asm("ei")
