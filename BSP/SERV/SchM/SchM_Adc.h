...
*******************************************************************************/
/*
 * V3.0.0:  07-Aug-2009  : Initial version
 */
/******************************************************************************/
...
#define SchM_Enter_Adc(ExclusiveArea) SchM_Enter_Adc_## ExclusiveArea 
#define SchM_Exit_Adc(ExclusiveArea) SchM_Exit_Adc_## ExclusiveArea

#define SchM_Enter_Adc_ADC_INT_PROTECTION                 __asm("di")
#define SchM_Exit_Adc_ADC_INT_PROTECTION                  __asm("ei")

#define SchM_Enter_Adc_ADC_RAMDATA_PROTECTION             __asm("di")
#define SchM_Exit_Adc_ADC_RAMDATA_PROTECTION              __asm("ei")
#endif /* SCHM_ADC_H */
