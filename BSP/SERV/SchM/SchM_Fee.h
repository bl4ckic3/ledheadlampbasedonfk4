...
*******************************************************************************/
/*
 * V3.0.0:  08-Nov-2009  : Initial Version
 */
/******************************************************************************/
#ifndef SCHM_FEE_H
#define SCHM_FEE_H
...
#define SchM_Enter_Fee(ExclusiveArea) SchM_Enter_Fee_## ExclusiveArea 
#define SchM_Exit_Fee(ExclusiveArea) SchM_Exit_Fee_## ExclusiveArea

#define SchM_Enter_Fee_FEE_STATUS_PROTECTION             __asm("di")
#define SchM_Exit_Fee_FEE_STATUS_PROTECTION              __asm("ei")
