...
#define CAN_INIT_AR_MAJOR_VERSION  2
#define CAN_INIT_AR_MINOR_VERSION  2
#define CAN_INIT_AR_PATCH_VERSION  2

/* File version information */
#define CAN_INIT_SW_MAJOR_VERSION  3
#define CAN_INIT_SW_MINOR_VERSION  0
