...
CONST(Mcu_ConfigType, MCU_CONST) Mcu_GstConfiguration[2] =
{
  ...
  /* Structure for initialization of database: 1 */
  {
    /* ulStartOfDbToc */
    0x05D94300,
...
CONST(Tdd_Mcu_ClockSetting, MCU_CONST) Mcu_GstClockSetting[2] =
{
  /* Index: 0 */
  {
    /* ulPLL0ControlValue */
...
CONST(Tdd_Mcu_ModeSetting, MCU_CONST) Mcu_GstModeSetting[4] =
{
  /* Index: 0 */
  {
...
CONST(uint16, MCU_CONST)Mcu_GaaCkscRegOffset[9] =
{
  /* Index: 0 */
  0x4090,
...
CONST(uint32, MCU_CONST)Mcu_GaaCkscRegValue[9] =
{
  /* Index: 0 */
  0x00000018,
...
*/
CONST(uint8, MCU_CONST)Mcu_GaaClkSettingIndexMap[4] =
{
  /* Index: 0 */
  0xFF,
