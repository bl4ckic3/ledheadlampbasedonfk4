...
#define GPT_PBCFG_C_SW_MINOR_VERSION     1
...
CONST(Tdd_Gpt_TAUUnitConfigType,GPT_CONST) Gpt_GstTAUUnitConfig[] =
{
  /* Tau: 0 */
  {
    ...
    (P2VAR(void, AUTOMATIC, GPT_CONFIG_DATA)) 0xFF811054ul,

    /* pTAUUnitOsCntlRegs */
    (P2VAR(void, AUTOMATIC, GPT_CONFIG_DATA)) 0xFF811090ul,
...
CONST(Tdd_Gpt_ChannelConfigType, GPT_CONST) Gpt_GstChannelConfig[] =
{
  ...
  {
    /* pBaseCtlAddress */
    (P2VAR(void, AUTOMATIC, GPT_CONFIG_DATA)) 0xFF811000ul,

    /* pCMORorCTLAddress */
    (P2VAR(uint16, AUTOMATIC, GPT_CONFIG_DATA)) 0xFF811080,

    /* pImrIntrCntlAddress */
    (P2VAR(void, AUTOMATIC, GPT_CONFIG_DATA))0xFFFF6410ul,

    /* pIntrCntlAddress */
    (P2VAR(uint16, AUTOMATIC, GPT_CONFIG_DATA))0xFFFF610Eul,
...
CONST(uint8, GPT_CONST) Gpt_GaaTimerChIdx[145] =
{
  /* Index:  0 */
