 ...
 */
#define MCU_RAM_C_AR_MAJOR_VERSION    MCU_AR_MAJOR_VERSION_VALUE
#define MCU_RAM_C_AR_MINOR_VERSION    MCU_AR_MINOR_VERSION_VALUE
#define MCU_RAM_C_AR_PATCH_VERSION    MCU_AR_PATCH_VERSION_VALUE


/* File version information */
#define MCU_RAM_C_SW_MAJOR_VERSION    3
#define MCU_RAM_C_SW_MINOR_VERSION    0

/*******************************************************************************
**                      Version Check                                         **
*******************************************************************************/
#if (MCU_RAM_AR_MAJOR_VERSION != MCU_RAM_C_AR_MAJOR_VERSION)
  #error "Mcu_Ram.c : Mismatch in Specification Major Version"
#endif

#if (MCU_RAM_AR_MINOR_VERSION != MCU_RAM_C_AR_MINOR_VERSION)
  #error "Mcu_Ram.c : Mismatch in Specification Minor Version"
#endif

#if (MCU_RAM_AR_PATCH_VERSION != MCU_RAM_C_AR_PATCH_VERSION)
  #error "Mcu_Ram.c : Mismatch in Specification Patch Version"
#endif

#if (MCU_RAM_SW_MAJOR_VERSION != MCU_RAM_C_SW_MAJOR_VERSION)
  #error "Mcu_Ram.c : Mismatch in Major Version"
#endif

#if (MCU_RAM_SW_MINOR_VERSION != MCU_RAM_C_SW_MINOR_VERSION)
  #error "Mcu_Ram.c : Mismatch in Minor Version"
#endif
...
P2CONST(Mcu_ConfigType, MCU_CONST, MCU_CONFIG_CONST) Mcu_GpConfigPtr;

/* Global pointer variable for MCU Clock Setting configuration */
P2CONST(Tdd_Mcu_ClockSetting, MCU_CONST, MCU_CONFIG_CONST) Mcu_GpClockSetting;
...
P2CONST(uint16, AUTOMATIC, MCU_CONFIG_CONST) Mcu_GpCkscRegOffset;
...
P2CONST(uint32, AUTOMATIC, MCU_CONFIG_CONST) Mcu_GpCkscRegValue;
